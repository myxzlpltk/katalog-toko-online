...
return [
    ...
    */
    ...
    'phone'                => ':Attribute harus berisi nomor HP yang valid.',
    ...
    */
    ...
    'attributes' => [
        ...
        'email' => 'Email',
        'file' => 'Berkas',
        'friday_close' => 'Jam tutup jumat',
        'friday_open' => 'Jam buka jumat',
        'logo' => 'Logo',
        'max_price' => 'Harga maksimum',
        'min_price' => 'Harga minimum',
        'monday_close' => 'Jam tutup senin',
        'monday_open' => 'Jam buka senin',
        'name' => 'Nama',
        'password' => 'Kata sandi',
        'phone_number' => 'Nomor HP',
        'rating' => 'Rating',
        'review_text' => 'Review',
        'saturday_close' => 'Jam tutup sabtu',
        'saturday_open' => 'Jam buka sabtu',
        'shop_id' => 'Toko',
        'sunday_close' => 'Jam tutup minggu',
        'sunday_open' => 'Jam buka minggu',
        'thursday_close' => 'Jam tutup kamis',
        'thursday_open' => 'Jam buka kamis',
        'tuesday_close' => 'Jam tutup selasa',
        'tuesday_open' => 'Jam buka selasa',
        'wednesday_close' => 'Jam tutup rabu',
        'wednesday_open' => 'Jam buka rabu',
    ],
];
