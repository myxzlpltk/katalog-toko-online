...
@section('breadcrumbs')
	{{ \Diglactic\Breadcrumbs\Breadcrumbs::render('console.business-types.edit', $businessType) }}
@endsection
...
@section('content')
	<div class="card shadow mb-3">
		...
		<div class="card-body">
			<form action="{{ route('console.business-types.update', $businessType) }}" method="post" enctype="multipart/form-data">
				@csrf
				@method('PATCH')
