...
Route::get('toko/{shop:slug}', [BusinessController::class, 'view'])->name('businesses.view');
Route::post('toko/{shop:slug}/add-review', [BusinessController::class, 'addReview'])->name('businesses.add-review');
